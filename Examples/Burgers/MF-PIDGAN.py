...
plt.savefig('./Figures/MF-PIDGAN-Exact-LF.png', dpi = 600)
####### Row 0: u(t,x) ##################
...
plt.savefig('./Figures/MF-PIDGAN-Prediction-LF.png', dpi = 600)
...
plt.savefig('./Figures/MF-PIDGAN-Error-LF.png', dpi = 600)
...
G = Generator(in_dim = 4, out_dim = 1, hid_dim = g_hid_dim, num_layers = g_num_layer).to(device)
Q = Q_Net(in_dim = 4, out_dim = 1, hid_dim = q_hid_dim, num_layers = q_num_layer).to(device)

burgers = Burgers_PIDGAN(X_u_train, u_train, X_f_train, X_star, u_star, G, D, Q, device, num_epochs, lambda_phy, lambda_mse, lambda_q, noise)
...
plt.ylabel('Error')
plt.yscale("log")
plt.savefig('./Figures/MF-PIDGAN-ErrorCurves.png', dpi = 600)
np.savetxt('./Outputs/MF-PIDGAN_Error_history.csv', Error_history, delimiter=',')
...
ax.set_title('$u(t,x): Exact$', fontsize = 20) # font size doubled
ax.tick_params(labelsize=15)

plt.savefig('./Figures/MF-PIDGAN-Exact.png', dpi = 600)
####### Row 0: u(t,x) ##################
...
plt.savefig('./Figures/MF-PIDGAN-Prediction.png', dpi = 600)
####### Row 0: u(t,x) ##################
...
# plt.savefig('./Figures/MF-PIDGAN-Error.png', dpi = 600)
plt.savefig('./Figures/MF-PIDGAN-Error.eps', dpi=266, bbox_inches='tight', format='eps')
plt.show()