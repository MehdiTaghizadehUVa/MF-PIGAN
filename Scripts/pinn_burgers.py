...
class Burgers_PINN():
    def __init__(self, x_u, y_u, x_f, X_star, u_star, net, device, nepochs, lambda_phy, noise = 0.0):
    ...
    def train(self):
        ...
        for epoch in range(self.nepochs):
            ...
            for i, (x, y) in enumerate(self.train_loader):
                ...
                y_pred, _ = self.get_response(x)
                _, residual = self.get_response(self.train_x_f)
